...
# coding:utf-8
 ...
 # ユーザーを一人ずつ作成します。
  ...
  cooking_image: File.open("./app/assets/images/meat_vegetables.jpg"),
  comment: "肉と野菜の歯応えが良い感じ。野菜は多い方が好き！")
  Recipe.create!(user_id: 4, cooking_name: "大根の煮物",
  cooking_image: File.open("./app/assets/images/boiled_food.jpg"),
  comment: "大根に煮汁が染み込んでて美味しかった！コツは長い時間煮込むことです。")
  Recipe.create!(user_id: 5, cooking_name: "鶏肉のトマトソース煮込み",
  cooking_image: File.open("./app/assets/images/tomato.jpg"),
  comment: "ニンニクが効いて刺激のある味で美味しかった。これは僕のお箱になりそう。")
  Recipe.create!(user_id: 6, cooking_name: "野菜炒め",
  cooking_image: File.open("./app/assets/images/fried_vegetables.jpg"),
  comment: "定番だけどやっぱり美味しい！短い時間で簡単に作れるので嬉しい。")
  ...
  cooking_image: File.open("./app/assets/images/beef.jpg"),
  comment: "やっぱりステーキはミディアム！ソースも美味しく作れたので良かった。")
  Recipe.create!(user_id: 9, cooking_name: "青椒肉絲",
  cooking_image: File.open("./app/assets/images/pepper_steak.jpg"),
  comment: "中華の中でこれが一番好き！どうして中華はこんなに病みつきになるんだろう。")
  Recipe.create!(user_id: 10, cooking_name: "シーザーサラダ",
  cooking_image: File.open("./app/assets/images/salad.jpg"),
  comment: "サラダはやっぱりシーザーサラダ！野菜のシャキシャキ食感も好き。")
  Recipe.create!(user_id: 1, cooking_name: "湯豆腐",
  cooking_image: File.open("./app/assets/images/tofu.jpg"),
  comment: "出汁が効いてて最高に美味しかった！だし汁まで飲んでしまった。")
  Recipe.create!(user_id: 2, cooking_name: "豚キムチ",
  cooking_image: File.open("./app/assets/images/prok_kimchi.jpg"),
  comment: "豚肉とキムチの相性抜群！キムチは無添加キムチです。")
  Recipe.create!(user_id: 3, cooking_name: "肉野菜炒め",
  cooking_image: File.open("./app/assets/images/meat_vegetables.jpg"),
  comment: "肉と野菜の歯応えが良い感じ。野菜は多い方が好き！")
  ...
  Ingredient.create!(recipe_id: 31, ingredient: "大根", amount: "1/2", unit: "個")
  Ingredient.create!(recipe_id: 31, ingredient: "鶏肉", amount: "200", unit: "グラム")
  Ingredient.create!(recipe_id: 31, ingredient: "にんじん", amount: "1", unit: "本")
  Ingredient.create!(recipe_id: 31, ingredient: "めんつゆ", amount: "2", unit: "大さじ")
  Ingredient.create!(recipe_id: 32, ingredient: "鶏肉", amount: "200", unit: "グラム")
  Ingredient.create!(recipe_id: 32, ingredient: "トマト缶", amount: "1", unit: "個")
  Ingredient.create!(recipe_id: 32, ingredient: "玉ねぎ", amount: "1", unit: "個")
  Ingredient.create!(recipe_id: 32, ingredient: "にんじん", amount: "1", unit: "本")
  Ingredient.create!(recipe_id: 33, ingredient: "キャベツ", amount: "1/4", unit: "個")
  Ingredient.create!(recipe_id: 33, ingredient: "玉ねぎ", amount: "1/2", unit: "個")
  Ingredient.create!(recipe_id: 33, ingredient: "にんじん", amount: "1/2", unit: "本")
  Ingredient.create!(recipe_id: 33, ingredient: "だしの素", amount: "1", unit: "小さじ")
  Ingredient.create!(recipe_id: 34, ingredient: "牛肉", amount: "200", unit: "グラム")
  Ingredient.create!(recipe_id: 34, ingredient: "豆腐", amount: "300", unit: "グラム")
  Ingredient.create!(recipe_id: 34, ingredient: "めんつゆ", amount: "2", unit: "大さじ")
  Ingredient.create!(recipe_id: 34, ingredient: "砂糖", amount: "2", unit: "小さじ")
  Ingredient.create!(recipe_id: 35, ingredient: "牛ステーキ肉", amount: "200", unit: "")
  Ingredient.create!(recipe_id: 35, ingredient: "牛脂", amount: "1", unit: "個")
  Ingredient.create!(recipe_id: 35, ingredient: "塩", amount: "少々", unit: "")
  Ingredient.create!(recipe_id: 35, ingredient: "胡椒", amount: "少々", unit: "")
  Ingredient.create!(recipe_id: 36, ingredient: "牛肉", amount: "150", unit: "グラム")
  Ingredient.create!(recipe_id: 36, ingredient: "ピーマン", amount: "2", unit: "個")
  Ingredient.create!(recipe_id: 36, ingredient: "細切り竹の子", amount: "150", unit: "グラム")
  Ingredient.create!(recipe_id: 36, ingredient: "パプリカ", amount: "2", unit: "個")
  Ingredient.create!(recipe_id: 37, ingredient: "レタス", amount: "1/2", unit: "個")
  Ingredient.create!(recipe_id: 37, ingredient: "玉ねぎ", amount: "1/4", unit: "個")
  Ingredient.create!(recipe_id: 37, ingredient: "クルトン", amount: "お好みで", unit: "")
  Ingredient.create!(recipe_id: 37, ingredient: "シーザードレッシング", amount: "お好みで", unit: "")
  Ingredient.create!(recipe_id: 38, ingredient: "豆腐", amount: "300", unit: "グラム")
  Ingredient.create!(recipe_id: 38, ingredient: "だしの素", amount: "1", unit: "大さじ")
  Ingredient.create!(recipe_id: 38, ingredient: "小ネギ", amount: "お好みで", unit: "")
  Ingredient.create!(recipe_id: 39, ingredient: "豚肉", amount: "150", unit: "グラム")
  Ingredient.create!(recipe_id: 39, ingredient: "キムチ", amount: "70", unit: "グラム")
  Ingredient.create!(recipe_id: 39, ingredient: "ごま油", amount: "1", unit: "大さじ")
  Ingredient.create!(recipe_id: 39, ingredient: "塩", amount: "少々", unit: "")
  Ingredient.create!(recipe_id: 40, ingredient: "豚肉細切れ", amount: "150", unit: "グラム")
  Ingredient.create!(recipe_id: 40, ingredient: "キャベツ", amount: "1/4", unit: "個")
  Ingredient.create!(recipe_id: 40, ingredient: "玉ねぎ", amount: "1/2", unit: "個")
  Ingredient.create!(recipe_id: 40, ingredient: "にんじん", amount: "1/2", unit: "本")
  ...
  Step.create!(
    recipe_id: 31, step_1: "具材を食べやすい大きさに切ります。",
    step_2: "具材全てを鍋に入れて火にかける。煮立ったら弱火で具材が柔らかくなるまで火にかける。",
    step_3: "爪楊枝がスッと刺さるくらい柔らかくなったら完成！"
  )
  Step.create!(
